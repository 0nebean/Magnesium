...
import net.onebean.api.mngt.api.model.ApiInfoCloudVo;
import net.onebean.api.mngt.vo.AppApiRelationshipAppVo;
import net.onebean.api.mngt.vo.UriApiRelationshipVo;
