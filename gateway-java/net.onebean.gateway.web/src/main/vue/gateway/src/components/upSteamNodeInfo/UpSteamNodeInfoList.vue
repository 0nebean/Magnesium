      ...
      <Row>
        ...
        <i-col span="2" offset="1" class="page-col">
          <FormItem prop="deployType">
            <Select
              v-model="paramData.data.deployType"
              @on-change="getdata"
              placeholder="部署类型"
              style="width:200px"
              clearable
        ...
        <i-col span="2" offset="1" class="page-col">
          <FormItem prop="programType">
            <Select
              v-model="paramData.data.programType"
              @on-change="getdata"
              placeholder="程序类型"
              style="width:200px"
              clearable
        ...
        <i-col span="2" offset="1" class="page-col">
          <FormItem prop="runningStatus">
            <Select
              v-model="paramData.data.runningStatus"
              @on-change="getdata"
              placeholder="运行状态"
              style="width:200px"
              clearable
            >
              <Option
                v-for="item in runningStatusEunmArr"
                :value="item.value"
                :key="item.value"
                >{{ item.label }}</Option
              >
        ...
        <i-col span="3" offset="19" class="button-group">
          <Button type="info" @click="pushAdd()">新增</Button>
    ...
    >
      <template slot-scope="{ row, index }" slot="action">
        ...
        <Button
          ...
          @click="setRunningStatusDownByDevOpsK8sNotificationVo(row)"
          >停止运行</Button
        >
        <Button
          type="error"
  ...
  methods: {
    ...
    setRunningStatusDownByDevOpsK8sNotificationVo(row) {
      ...
      this.utils.netUtil.post(
        ...
        response => {
          const stopResult = response.data.data
