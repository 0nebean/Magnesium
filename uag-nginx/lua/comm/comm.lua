...
--获取当前请求地址的主域名，比如http://cloud.onebean.net/portal/index.html则返回http://cloud.onebean.net
...
--获取当前请求地址（不带参数），比如http://cloud.onebean.net/portal/index.html
...
-- 比如http://cloud.onebean.net/portal/xxxxx?aa=b#c，会丢失#c
